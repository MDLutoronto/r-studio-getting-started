...
layout: "home"
description: "This guide helps you get started with the R and RStudio software and R code. You can install R from the R homepage. And you can install RStudio from the RStudio homepage. A more thorough introduction to the R language is covered here."
staff:
    - name: Nadia Muhe
...
[R](#r)  
[RStudio](#rstudio)  
[Getting Started with R code](#getting-started-with-r-code)
...
You need to install both R and RStudio to use R in RStudio. The latest version of the free RStudio environment can be downloaded [here](https://www.rstudio.com/products/rstudio/download/). The free open-source version is RStudio Desktop. 
